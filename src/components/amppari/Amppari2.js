...
import SignalSelectedValue from "./SignalSelectedValue";
...
export default class Amppari2 extends Component {
  store = null;
  ...
  listenerStoreChange2 = (storestate) => {
    if (Config.bDebug) {
      console.log("Amppari2 listenerStoreChange2");
      console.log(storestate);
    }
    if (storestate === undefined || storestate === null) {
      console.log("Amppari2 listenerStoreChange storestate");
      return;
    }
