...
//            scrollingDlgRef.current.MDComponent.show();
    ...
    // +this.getPOfTitleIndex()
		...
		return (			
			...
			<Dialog role="dialog" id={"dialogtheme" +digalogId} aria-modal="true"
                 lang="fi" ref={scrollingDlgRef}
                 ...
                 >
					<div 
                      style={divDialogStyle}>
                       <h3 lang="fi" id="h3program" tabIndex="0" class=" mdc-typography--title">{props.channelname}</h3>
