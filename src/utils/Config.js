...
class Config {
  ...
  static textFieldFocus =
    "  outline: 4px solid black; color: black; caret-color: auto; background-color: white; ";
  static textFieldFocusWhite =
    " outline: 4px solid white; color: white; caret-color: auto; background-color: black; ";
  static textFieldStype =
    " outline: 1px solid black; width: 90%; caret-color: auto; color: black; background-color: white; ";
  static textFieldStypeWhite =
    " outline: 1px solid white; width: 90%; caret-color: auto; color: #FFF; background-color: black; ";
  ...
  static setOwnserveraddress(p_hostname, p_host) {
    ...
    Config.http_curlserver =
      "http://" + p_hostname + ":" + ProxyServerPort.port;
  }
